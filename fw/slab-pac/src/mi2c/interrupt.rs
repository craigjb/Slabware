...
#[doc = "Field `clockGenExitEnable` reader - Clock gen exit enable\n\n<div class=\"warning\">The field is <b>modified</b> in some way after a read operation.</div>"]
pub type ClockGenExitEnableR = crate::BitReader;
#[doc = "Field `clockGenExitEnable` writer - Clock gen exit enable"]
pub type ClockGenExitEnableW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `clockGenExitFlag` reader - Clock gen exit flag\n\n<div class=\"warning\">The field is <b>modified</b> in some way after a read operation.</div>"]
pub type ClockGenExitFlagR = crate::BitReader;
#[doc = "Field `clockGenExitFlag` writer - Clock gen exit flag"]
pub type ClockGenExitFlagW<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `clockGenEnterEnable` reader - Clock gen enter enable\n\n<div class=\"warning\">The field is <b>modified</b> in some way after a read operation.</div>"]
pub type ClockGenEnterEnableR = crate::BitReader;
#[doc = "Field `clockGenEnterEnable` writer - Clock gen enter enable"]
pub type ClockGenEnterEnableW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `clockGenEnterFlag` reader - Clock gen enter flag\n\n<div class=\"warning\">The field is <b>modified</b> in some way after a read operation.</div>"]
pub type ClockGenEnterFlagR = crate::BitReader;
#[doc = "Field `clockGenEnterFlag` writer - Clock gen enter flag"]
pub type ClockGenEnterFlagW<'a, REG> = crate::BitWriter1C<'a, REG>;
impl R {
    ...
    #[doc = "Bit 12 - Clock gen exit enable"]
    #[inline(always)]
    pub fn clock_gen_exit_enable(&self) -> ClockGenExitEnableR {
        ClockGenExitEnableR::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - Clock gen exit flag"]
    #[inline(always)]
    pub fn clock_gen_exit_flag(&self) -> ClockGenExitFlagR {
        ClockGenExitFlagR::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Clock gen enter enable"]
    #[inline(always)]
    pub fn clock_gen_enter_enable(&self) -> ClockGenEnterEnableR {
        ClockGenEnterEnableR::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - Clock gen enter flag"]
    #[inline(always)]
    pub fn clock_gen_enter_flag(&self) -> ClockGenEnterFlagR {
        ClockGenEnterFlagR::new(((self.bits >> 15) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - RX data interrupt enable"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn clock_gen_exit_enable(&mut self) -> ClockGenExitEnableW<InterruptSpec> {
        ClockGenExitEnableW::new(self, 12)
    }
    #[doc = "Bit 13 - Clock gen exit flag"]
    #[inline(always)]
    #[must_use]
    pub fn clock_gen_exit_flag(&mut self) -> ClockGenExitFlagW<InterruptSpec> {
        ClockGenExitFlagW::new(self, 13)
    }
    #[doc = "Bit 14 - Clock gen enter enable"]
    #[inline(always)]
    #[must_use]
    pub fn clock_gen_enter_enable(&mut self) -> ClockGenEnterEnableW<InterruptSpec> {
        ClockGenEnterEnableW::new(self, 14)
    }
    #[doc = "Bit 15 - Clock gen enter flag"]
    #[inline(always)]
    #[must_use]
    pub fn clock_gen_enter_flag(&mut self) -> ClockGenEnterFlagW<InterruptSpec> {
        ClockGenEnterFlagW::new(self, 15)
    }
}
...
impl crate::Writable for InterruptSpec {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0xaaa0;
}
