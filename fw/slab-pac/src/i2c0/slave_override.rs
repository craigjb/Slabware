...
impl R {
    #[doc = "Bit 1 - Force the SDA pin low when cleared"]
    #[inline(always)]
    pub fn sda(&self) -> SdaR {
        SdaR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Force the SCL pin low when cleared"]
    #[inline(always)]
    pub fn scl(&self) -> SclR {
        SclR::new(((self.bits >> 2) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 1 - Force the SDA pin low when cleared"]
...
#[doc = "`reset()` method sets slaveOverride to value 0x06"]
